...
def query_web(question: str):
    ...
    try:
        ...
        print("⚠️ Web search API timed out.")
        return "Web se answer nahi mil paaya, please dobara try karo."
    except Exception as e:
        print(f"⚠️ Web search API error: {e}")
        return "Web se answer nahi mil paaya, please dobara try karo."
...
"""
    llm = OpenAI(api_key=OPENAI_API_KEY, model="gpt-3.5-turbo", temperature=0.2)
